...
/**
 * Specialised restore for Evoke course format.
 *
 ...
 * @author    Willian Mano <willianmanoaraujo@gmail.com>
 */
class restore_format_evoke_plugin extends restore_format_plugin {
    ...
    public function after_restore_course() {
        ...
        $backupinfo = $this->step->get_task()->get_info();
        if ($backupinfo->original_course_format !== 'evoke' || !isset($data['tags']['numsections'])) {
